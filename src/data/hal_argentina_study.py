...
def write_study(frac: pd.DataFrame, op_exp: pd.DataFrame, form_risk: pd.DataFrame,
    ...
    lines += [
        ...
        "    ✓ Domain 1 — Hydraulic Fracturing (Stimulation):  CONFIRMED ACTIVE",
        ...
        "      (SESCO Finished WEll data). HAL holds major cementing market share.",
        "",
        ...
        "    Primary exposure: Res. SE 317/2021 (unconventional ops) + Law 24.051 (waste)",
