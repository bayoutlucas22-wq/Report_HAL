...
This repository can be published as a **public study** version if the raw source material, ingestion scripts, and private operational data are excluded or moved to a private companion repository.

What belongs in the public version:
- Derived findings and summaries
- Sanitized methodology notes
- Abstracted charts, tables, and diagrams
- Reproducible code that works only on already-processed, non-sensitive samples

What should stay private:
- Raw source dumps
- Direct source URLs and archive bundles
- Internal deployment scripts
- Credentials, tokens, and environment files
- Full ingestion pipelines tied to restricted datasets

For the public-facing structure, see [`public-study/README.md`](public-study/README.md).
...
---
*Public Study Edition — source data abstracted and sanitized for publication*
